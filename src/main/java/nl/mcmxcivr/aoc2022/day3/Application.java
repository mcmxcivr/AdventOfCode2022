...
class Application {
  ...
  public static void main(String[] args) {
    RucksackReorganization rucksackReorganization = RucksackReorganization.fromString(INPUT);

    System.out.println("Answer 1: " + rucksackReorganization.sumItemTypePriorities());
    System.out.println("Answer 2: " + rucksackReorganization.sumItemTypePrioritiesForGroupsOfThree());
  }
